                ...
                <div class="team-layout-1">       
                    ...
                    <figure class="team-member">
                        <a href="#" title="ALEXANDER GARY">
                            <img src="{{ asset('assets/images/team_9.jpg') }}" alt="ALEXANDER GARY"/>
                        </a>
                ...
                <div class="team-layout-1">       
                    ...
                    <figure class="team-member">
                        <a href="#" title="MELISSA MUNOZ">
                            <img src="{{ asset('assets/images/team_6.jpg') }}" alt="MELISSA MUNOZ" />
                        </a>
                ...
                <div class="team-layout-1">       
                    ...
                    <figure class="team-member">
                        <a href="#" title="JOHN ABRAHAM">
                            <img src="{{ asset('assets/images/team_7.jpg') }}" alt="JOHN ABRAHAM" />
                        </a>                               
