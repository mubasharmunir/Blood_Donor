...
{   
 ...
 public function login_store(Request $request){
  ...
  public function donor_delete($id){
    ...
    if($donor_delete){
      ...
      $donor_delete->delete();
      return back()->with('danger', 'Donor  is successfully deleted');
  ...
  public function donor_update(Request $request,$id){
   ...
   $blood_donors ->save();
   return back()->with('success', 'Donor is successfully updated');
  ...
  public function page_store(Request $request){
    ...
    $save->save();
    return back()->with('success', 'page  is successfully Added');
    // return view('admin.pages.create_pages');
  }
 ...
 public function  list_valunteers(){
  return view('admin.volunteers.list');

 }
 public function create_valunteers(){
  return view('admin.volunteers.create');
 }
 public function store_valunteers(Request $request){
    $request->validate([
     'name' => 'required',
 ...
 public function  list_val(){ 
   $list_volunteers = Volunteer::get();
   return view('admin.volunteers.list',compact('list_volunteers'));
 }
